...
DATA_ROOT=/home/yaqing/Projects/MetaST/MetaXtremeLearning/dataset/snips/
...
CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=$GPUID python3 run_self_training_active_learning.py --data_dir $DATA_ROOT \
