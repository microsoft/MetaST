...
SHOT=10
SCENARIO=mobile
#python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/train.txt
#python3 preprocess.py ./train_aug_back.txt $BERT_MODEL $MAX_LENGTH > train.txt
python3 preprocess.py $DATA_ROOT/train_bio/train_whole_${SHOT}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/train.txt
python3 preprocess.py $DATA_ROOT/train_bio/unlabeled_train_whole_${SHOT}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/unlabeled_train.txt
#python3 preprocess.py $DATA_ROOT/train_bio/unlabeled_aug_train_whole_${SHOT}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/unlabeled_train.txt
...
python3 preprocess.py $DATA_ROOT/train_bio/dev_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/dev.txt
python3 preprocess.py $DATA_ROOT/validate_bio/whole_${SCENARIO}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/test.txt
#python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/test.txt
...
# output
OUTPUT=$PROJECT_ROOT/outputs/email_search/self_training_controler/aug_${SCENARIO}_${SHOT}/${MODEL_TYPE}_reinit${REINIT}_begin${BEGIN_STEP}_period${PERIOD}_${LABEL_MODE}_hp${HP_LABEL}_${EPOCH}_${LR}_${USE_CONTROLER}/
...
CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=$GPUID python3 run_self_training_teacher_joint.py --data_dir $DATA_ROOT \
...
#python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/train.txt
##python3 preprocess.py ./train_aug_back.txt $BERT_MODEL $MAX_LENGTH > train.txt
##python3 preprocess.py $DATA_ROOT/train_bio/train_whole_rand_${SHOT}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/train.txt
#python3 preprocess.py $DATA_ROOT/train_bio/unlabeled_train_whole_rand_${SHOT}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/unlabeled_train.txt
##python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/aug_train_whole.txt $BERT_MODEL $MAX_LENGTH > train.txt
#python3 preprocess.py $DATA_ROOT/train_bio/dev_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/dev.txt
##python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/dev.txt
#python3 preprocess.py $DATA_ROOT/validate_bio/whole_${SCENARIO}.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/test.txt
##python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole_30.txt $BERT_MODEL $MAX_LENGTH > test.txt
##python3 preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/train_whole_70.txt $BERT_MODEL $MAX_LENGTH > $DATA_ROOT/test.txt
##preprocess.py /home/t-yaqwan/Projects/data/EmailSearch/train_bio/aug_train_whole.txt $BERT_MODEL $MAX_LENGTH > test.txt
